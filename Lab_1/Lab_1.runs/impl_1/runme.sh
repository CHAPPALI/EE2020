...
HD_PWD='C:/Users/Administrator.UER-PC/Lab_1/Lab_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Led_flasher.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Led_flasher.tcl -notrace
