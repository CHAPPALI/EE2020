...
HD_PWD='F:/Vivado/lab_3/lab_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log slow_blinky_module.vds -m64 -mode batch -messageDb vivado.pb -notrace -source slow_blinky_module.tcl
