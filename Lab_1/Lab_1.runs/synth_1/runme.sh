...
HD_PWD='C:/Users/Administrator.UER-PC/Lab_1/Lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Led_flasher.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Led_flasher.tcl
