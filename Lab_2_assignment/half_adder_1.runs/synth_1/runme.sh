...
HD_PWD='C:/Users/Administrator.UER-PC/OneDrive - National University of Singapore/Vivado/half_adder_1/half_adder_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_2_bit_adder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source my_2_bit_adder.tcl
