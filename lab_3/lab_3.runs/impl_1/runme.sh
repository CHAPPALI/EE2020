...
HD_PWD='F:/Vivado/lab_3/lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log slow_blinky_module.vdi -applog -m64 -messageDb vivado.pb -mode batch -source slow_blinky_module.tcl -notrace
